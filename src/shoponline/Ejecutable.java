...
import static shoponline.Metales.ORO;
import static shoponline.Metales.PLATA;
import static shoponline.Modelos.OXFORD;
import static shoponline.Modelos.SKINNY;
import static shoponline.Talle.L;
import static shoponline.Talle.M;
...
public class Ejecutable {
    ...
    public static void main(String[] args) {
        ...
        productos.add(new Remera("Remera", "Recta blanca", 2300, L));
        productos.add(new Pantalon(OXFORD , "" ,5000, 44));
        productos.add(new Accesorio("collar", "dije cruz", 1800, "bijouteria", ORO));
        productos.add(new Accesorio("anillo", "de compromiso", 1100, "bijouteria", PLATA));
        productos.add(new Remera("Musculosa", "negra", 5600, M));
        productos.add(new Pantalon(SKINNY , "" ,1200, 42));
